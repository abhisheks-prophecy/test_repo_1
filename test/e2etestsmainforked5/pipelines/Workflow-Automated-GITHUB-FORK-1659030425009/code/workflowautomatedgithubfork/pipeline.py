...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "10918/pipelines/Workflow-Automated-GITHUB-FORK-1659030425009")
    MetricsCollector.start(spark = spark, pipelineId = "10918/pipelines/Workflow-Automated-GITHUB-FORK-1659030425009")
    pipeline(spark)
