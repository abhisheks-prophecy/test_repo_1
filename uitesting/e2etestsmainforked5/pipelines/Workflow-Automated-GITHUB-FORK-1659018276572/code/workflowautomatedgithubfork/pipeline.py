...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "9041/pipelines/Workflow-Automated-GITHUB-FORK-1659018276572")
    MetricsCollector.start(spark = spark, pipelineId = "9041/pipelines/Workflow-Automated-GITHUB-FORK-1659018276572")
    pipeline(spark)
