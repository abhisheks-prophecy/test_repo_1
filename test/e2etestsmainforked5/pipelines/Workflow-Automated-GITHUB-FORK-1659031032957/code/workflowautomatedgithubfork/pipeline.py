...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "10925/pipelines/Workflow-Automated-GITHUB-FORK-1659031032957")
    MetricsCollector.start(spark = spark, pipelineId = "10925/pipelines/Workflow-Automated-GITHUB-FORK-1659031032957")
    pipeline(spark)
